...
<a href="tree/" style="display: block; text-decoration: none; border: 1px solid rgba(95,191,130,0.4); border-radius: 12px; padding: 2rem; text-align: center; background: linear-gradient(135deg, rgba(95,191,130,0.08), transparent);">
